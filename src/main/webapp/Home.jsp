<%-- 
    Document   : Home
    Created on : 24 May, 2015, 8:56:21 PM
    Author     : ANKUR
--%>
...
<body>
    <%response.sendRedirect("English/Home.jsp");%>
  <div id="main">
    <div id="header">
	  <div id="banner">
	    <div id="welcome">
	      <h1><span>Chauhan</span> Traders</h1>
	    </div><!--close welcome-->
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="projects.html">Rate List</a></li>
...
<!--	  <div class="content_grey_container_box">
  ...
  <div id="footer">
      <a href="http://validator.w3.org/check?uri=referer">copyright &COPY; chauhantraders.com</a>
  </div><!--close footer-->  
